...
/* 📌Thiết lập đường dẫn khớp vs tất cả các URL (path= ‘*’ )
- Để hiển thị 1 page dự phòng hay Not Found, sẽ thường thêm 1 route vs điều kiện 0 có route nào trùng vs y/c.
-- Tức là ta sẽ thực hiện đối chiếu URL.
--- Dấu "*" cho Route biết any path nào, any URL nào cũng phải khớp vs route này.
---- Do đó, route này phải dc đối chiếu cuối cùng để tránh mất y/c đến 1 trong những route thực sự trùng khớp. Nếu sau khi đối chiếu mà vẫn 0 thấy route trùng khớp thì coi mọi URL sẽ khớp route cuối cùng này.
*/
